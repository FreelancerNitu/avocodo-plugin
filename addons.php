                ...
                $html .= '<div class="featured-cat-products">';
                    ...
                    if(!empty($thumb_id)) {
                        $html .= '<div class="col-lg-6">
                            <a href="'.$url.'" ><div class="f-cat-thumb" style="background-image:url('.$term_img.')"></div></a>
                        </div>';
                    }
                    // Query for Product Link
                    global $product;
       ...
       $repeater = new \Elementor\Repeater();
        ...
        $step_2_q = new WP_Query( array(
          ...
          <script>
           jQuery(document).ready(function($){
            ...
            $("#nav-home .step-1-product-button a.button").on("click", function(){
                $(\'.nav-tabs a[href="#nav-profile"]\').tab("show");
                $("html, body").animate({scrollTop: 0}, "slow");
                $(\'.nav-tabs a[href="#nav-profile"]\').attr("data-bs-toggle", "tab");
                $(\'.nav-tabs a[href="#nav-contact"]\').attr("data-bs-toggle", "tab");
            });
          ...
          <div class="step-indecator">
            ...
            <div class="nav nav-tabs" id="nav-tab" role="tablist">
                <button class="nav-link active" id="nav-home-tab" data-bs-toggle="tab" data-bs-target="#nav-home" type="button" role="tab" aria-controls="nav-home" aria-selected="true">Step 1</button>

                <button class="nav-link" id="nav-profile-tab" data-bs-toggle="tab" data-bs-target="#nav-profile" type="button" role="tab" aria-controls="nav-profile" aria-selected="false">Step 2</button>

                <button class="nav-link" id="nav-contact-tab" data-bs-toggle="tab" data-bs-target="#nav-contact" type="button" role="tab" aria-controls="nav-contact" aria-selected="false">Step 3</button>
                
                
                <button class="nav-link" id="nav-contact-tab" data-bs-toggle="tab" data-bs-target="#nav" type="button" role="tab" aria-controls="nav-contact" aria-selected="false">Step 4</button>
        ...
        <div class="tab-content" id="nav-tabContent">
          <div class="tab-pane fade show active" id="nav-home" role="tabpanel" aria-labelledby="nav-home-tab" tabindex="0">
           <h2 class="step-header-text text-center">'.do_shortcode(wpautop($settings['top_text'])).'</h2>
           ...
           <div class="row">';
              ...
              global $product;
               $html .='<div class="col">
                    <div class="step-1-product">
                       ...
                       <div class="step-1-product-price">Price:
                        '.$product->get_price_html().'
                       </div>
                       <div class="step-1-product-button">
            ...
            <div class="tab-pane fade" id="nav-profile" role="tabpanel" aria-labelledby="nav-profile-tab" tabindex="0">
                ...
                <div class="row">
                    <div class="col-lg-6 col-sm-12">
                       <div class="step-two-img">
                       <img src="'.wp_get_attachment_url($settings['step_two_image'], 'large' ).'" alt=""/>
                    ...
                    <div class="col-lg-6 col-sm-12">
                                           ...
                                           foreach($box['box_product_ids'] as $box_p){
                                            $html .='<div class="col">
                                                <div class="box-single-product">
                                                   <h4>'.get_the_title($box_p).'</h4>
                                                   <div class="box-product-bg" style="background-image:url('.get_the_post_thumbnail_url($box_p, 'medium').')"></div>
                        ...
                        $html .='
                        <div class="next-step-link text-right"><a href="" class="bordered-btn">Next Step <i class="fa fa-double-angle-right"></i></a></div>
                    </div> 
            ...
            <h2 class="step-title text-center">'.$settings['step-three-title'].'</h2>';
            if(!empty($settings['step_three_products'])){
                 ...
                 foreach($settings['step_three_products'] as $step_3_p){
                    ...
                    $html .='<div class="col-lg-3">
                      <div class="step-3-product">
                        ...
                        '.get_the_post_thumbnail($step_3_p, 'large').'
                        </div>
                        <div class="step-3-product-title">
                        '.get_the_title($step_3_p).'
                        </div>
                        <div class="step-3-product-content">
                        '.wpautop(get_the_excerpt($step_3_p)).'
                        </div>
                        <div class="step-3-product-price">
                        <b>Price</b>: '.$_product->get_price_html().'
                        </div>
                ...
                $html .='<div class="">No Products Added. Please add some products</div>';
               }
            $html .='
                <div class="checkout-bar">
                <div class="row">
                <div class="col-lg-7 text-right my-auto"><p>Ready To Checkout</p></div>
                <div class="col-lg-5 my-auto">
                    <a href="'.get_page_link(wc_get_page_id('checkout')).'?steps=true" class="bordered-btn-c">CHECKOUT</a>
                </div>
                </div>
            </div>
